...
extern dll_append(Dllist, Jval);//chèn vào cuối danh sách
extern dll_prepend(Dllist, Jval);//chèn vào đầu danh sách
extern dll_insert_b(Dllist, Jval);//insert before
extern dll_insert_a(Dllist, Jval);//insert after
...
#define dll_first(d) ((d)->flink) // trả về phần tử đầu danh sách
#define dll_next(d) ((d)->flink)  // trả về phần từ kế tiếp phần từ d
#define dll_last(d) ((d)->blink)  // trả về phần tử cuối danh sách
#define dll_prev(d) ((d)->blink)  // trả về phần tử ngay trước d trong danh sách
#define dll_nil(d) (d)
